  ...
  <contents xsi:type="folder:Folder" name="Scenarios" timeCreated="2015-11-06T13:21:08.840+0100" lastModified="2015-11-26T16:41:28.846+0100" uniqueID="3e314dda-ffb5-4a5b-baeb-c09e9c23d311">
    ...
    <contents xsi:type="ucScenario:Scenario" label="HE-Allergy" name="An allergic reaction" elementKind="unspecified" description="Rudolph who is unknowingly allergic to insect bites is relaxing in the local park when he is stung by a bee and gets a severe allergic reaction.&#xD;&#xA;Luckily Peter who has some allergies of his own is there and acts fast by calling the emergency call center which dispatches an ambulance to get Rudolph to the nearest hospital.&#xD;&#xA;While at the hospital Rudolph develops some complications the doctors haven't experienced before it is therefore good that they have access to a online diagnostics system that helps them treat him.&#xD;&#xA;After a short stay Rudolph is released now with a new allergy added to his eHealth card." timeCreated="2015-11-25T13:35:58.370+0100" lastModified="2015-11-26T16:41:28.846+0100" uniqueID="51728d5b-5d09-4f9f-b659-46cb099d889e" workPackage="">
      ...
      <startConnector xsi:type="ucScenario:Connector" name="Start connector">
        ...
        <connections xsi:type="ucScenario:Connector" description="Request help from a specialist.&#xA;" parent="//@contents.0/@contents.0/@startConnector" name="Use tier 1 system.&#xA;">
          <connections xsi:type="ucScenario:Action" description="Dr. Yasin flags the patients journal, as containing undiagnosed symbtoms." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="Dr. Yasin: Flag case for help."/>
          <connections xsi:type="ucScenario:Action" description="The system analyses the patients journal and tags it based on recently gathered data. One of the tags indicates that the symptoms might have something to do with an inflamatory desease." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="System: Analyse journal"/>
          <connections xsi:type="ucScenario:Action" description="Based on the tags, just matched with the journal, the system sends out a request for help on the case to specialists who are experts in the required fields." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="System: Request diagnostics"/>
          <connections xsi:type="ucScenario:Action" description="A specialist in inflamatory deseases receives a request to review a case. He opens the patients journal and reviews the case. He decides that this is something he can contribute on." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="Specialist: Review case"/>
          <connections xsi:type="ucScenario:Action" description="The specialist submits his conclusion. The system notifies the doctor on shift, which is responsible for the patient, of an update on the case." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="Specialist: Submit conclusion."/>
          <connections xsi:type="ucScenario:Action" description="The specialist concludes that the symptoms might be due to an inflamation in the patients kidneys. More precicly, that the patient might be suffering from proteiuria, hypoalbumenemia and edema. He writes in his conclution that a blood test, checking for these specific markers, must be performed as to confirm his proposed diagnosis. Further more, he suggests a treatment should the blood test be conclusive." parent="//@contents.0/@contents.0/@startConnector/@connections.28" name="Specialist: Conclude on a case."/>
        </connections>
